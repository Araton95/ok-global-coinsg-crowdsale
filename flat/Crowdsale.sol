...
contract Crowdsale is CappedCrowdsale, TimedCrowdsale {
  constructor (uint256 rate, address wallet, IERC20 token, uint256 cap, uint256 openingTime, uint256 closingTime)
    public
